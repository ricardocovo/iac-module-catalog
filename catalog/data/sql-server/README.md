...
This module deploys an Azure SQL Server using Azure Verified Modules (AVM).

## Module Reference

- **AVM Module**: `br/public:avm/res/sql/server:0.6.0`
...
```bicep
module sqlserver '../sql-server/main.bicep' = {
...
- [Azure Documentation](https://learn.microsoft.com/azure/azure-sql/)
